...
public class MicroState {
    ...
    public void setADDR1MUX(String str) {
        System.out.println("editing addr1MUX");
        this.addr1MUX.set(str);
    }
    ...
    public void setADDR2MUX(String str) {
        System.out.println("editing addr2MUX");
        this.addr2MUX.set(str);
    }
    ...
    public void setMARMUX(String str) {
        System.out.println("editing marMUX");
        this.marMUX.set(str);
    }
    ...
    public void setALUK(String str) {
        System.out.println("editing aluk");
        this.aluK.set(str);
    }
    ...
    public void setMEMEN(String str) {
        System.out.println("editing memEN");
        this.memEN.set(str);
    }
    ...
    public void setNEXT(String str) {
        System.out.println("editing next");
        this.next.set(str);
    }
